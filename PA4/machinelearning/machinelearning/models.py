...
class PerceptronModel(object):
    ...
    def run(self, x):
        ...
        # take the dot product of input and weights
    ...
    def get_prediction(self, x):
        ...
        # get the predicted class for the given input
        predicted_value = self.run(x)
        
        # if class is less than 0, return -1, otherwise, return 1
        if nn.as_scalar(predicted_value) < 0:
            return -1 
        else:
            return 1
    ...
    def train(self, dataset):
        ...
        while True:
            ...
            for x, y in dataset.iterate_once(1):
                ...
                # check if the predicted values is equal to true value i.e. y
